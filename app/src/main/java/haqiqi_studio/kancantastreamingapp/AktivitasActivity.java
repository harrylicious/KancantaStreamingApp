...
public class AktivitasActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_aktivitas);
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabAktivitas);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Snackbar.make(toolbar, "Gallery Selected.", Snackbar.LENGTH_SHORT).show();
